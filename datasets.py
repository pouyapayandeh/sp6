...
class NSDTSEADataset():
    ...
    def get_random_batch_generator(self, set):
        ...
        while True:
            ...
            batch_inputs = np.nan_to_num(np.array(batch_inputs, dtype='float32'))
            batch_outputs_1 = np.nan_to_num(np.array(batch_outputs_1, dtype='float32'))
            batch_outputs_2 = np.nan_to_num(np.array(batch_outputs_2, dtype='float32'))
